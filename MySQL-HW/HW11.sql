--- simple system for a school library. Each book has a unique ID and belongs to a single category (like Fiction, Science, History, etc.), but each category can have many books.
--Create two tables:
